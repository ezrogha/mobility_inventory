...
<body>
  <div class="form">
      <img src="images/FHMM.png" width="150px" style="margin-left: 25%; padding-top: 30px; padding-bottom: 30px;">
      <ul class="tab-group">
        <li class="tab"><a href="#login">Staff</a></li>
        <li class="tab active"><a href="#signup">Volunteer</a></li>
      </ul>
      ...
      <div class="tab-content">
        ...
        <div id="signup">   
          ...
          <div class="field-wrap">
            <label>
              <!--Username Address--><span class="req"><!--*--></span>
            </label>
          ...
          <input type="submit" class="button button-block" name="volunteer" value="LOGIN"/>
            ...
            <a href="admin_login.php" class="admin_link">Login as Admin</a>
        </div>  
        ...
        <div id="login">   
          ...
          <input type="submit" class="button button-block" name="staff" value="LOGIN"/>
